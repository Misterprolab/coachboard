// Dati esercizi di default — senza dipendenze da drizzle/sqlite
...
export function getDefaultExercises(now: number) {
  return [
    {
      id: uid(), name: 'Riscaldamento tecnico progressivo a coppie', nameEn: 'Progressive technical warm-up in pairs',
      ...
      {
        id: uid(), name: 'Possesso 4vs4 + portieri', nameEn: 'Possession 4v4 + goalkeepers',
        category: 'riscaldamento',
      ...
      // ── TECNICA ────────────────────────────────────────────────────────────
      {
        id: uid(), name: 'Combinazione 1-2 con terzo uomo', nameEn: 'One-two combination with third man',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Controllo orientato e conduzione', nameEn: 'Oriented control and dribbling',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Finishing: cross e attacco al secondo palo', nameEn: 'Finishing: cross and far post attack',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Duello 1vs1 in zona', nameEn: '1v1 duel in zone',
        category: 'tecnica',
      ...
      // ── TATTICA ────────────────────────────────────────────────────────────
      {
        id: uid(), name: 'Pressing alto coordinato (3-2-5 vs 4-3-3)', nameEn: 'Coordinated high press (3-2-5 vs 4-3-3)',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Costruzione bassa 3-2 vs pressing 4-4', nameEn: 'Low build-up 3-2 vs 4-4 press',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Transizioni 6vs6: attacco e difesa', nameEn: '6v6 transitions: attack and defense',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Blocco difensivo 4-4-2 (bassa intensità)', nameEn: '4-4-2 defensive block (low block)',
        category: 'tattica',
      ...
      // ── ATLETICO ───────────────────────────────────────────────────────────
      {
        id: uid(), name: 'Sprint ripetuti con cambio di direzione (COD)', nameEn: 'Repeated sprints with change of direction',
        category: 'atletico',
      ...
      {
        id: uid(), name: 'HIT integrato con palla (5-3-2)', nameEn: 'Ball-integrated HIIT (5-3-2)',
        category: 'atletico',
      ...
      {
        id: uid(), name: 'Forza funzionale calciatore (circuito)', nameEn: 'Footballer functional strength circuit',
        category: 'atletico',
      ...
      {
        id: uid(), name: 'Resistenza aerobica con palla (SSG)', nameEn: 'Aerobic endurance with ball (SSG)',
        category: 'atletico',
      ...
      // ── PARTITELLA ─────────────────────────────────────────────────────────
      {
        id: uid(), name: 'Partitella a tema: gestione del vantaggio', nameEn: 'Themed match: managing the lead',
        category: 'partitella',
      ...
      {
        id: uid(), name: 'Partitella con porte multiple (5v5)', nameEn: 'Multi-goal match (5v5)',
        category: 'partitella',
      ...
      {
        id: uid(), name: 'Possesso con zone proibite', nameEn: 'Possession with forbidden zones',
        category: 'partitella',
      ...
      // ── CALCI PIAZZATI ─────────────────────────────────────────────────────
      {
        id: uid(), name: 'Schema corner: blocco + taglio incrociato', nameEn: 'Corner scheme: block + cross-cut',
      ...
      {
        id: uid(), name: 'Punizione diretta da 20-25m', nameEn: 'Direct free kick from 20-25m',
        category: 'calci_piazzati',
      ...
      {
        id: uid(), name: 'Rimessa laterale in zona offensiva', nameEn: 'Throw-in in offensive third',
        category: 'calci_piazzati',
      ...
      // ── PORTIERI ───────────────────────────────────────────────────────────
      {
        id: uid(), name: 'Riflessi e posizionamento ravvicinato', nameEn: 'Reflexes and short-range positioning',
        category: 'portieri',
      ...
      {
        id: uid(), name: 'Uscita alta: timing e presa in volo', nameEn: 'High ball exit: timing and aerial catch',
        category: 'portieri',
      ...
      {
        id: uid(), name: 'Portiere: costruzione e pressione', nameEn: 'Goalkeeper: build-up under pressure',
        category: 'portieri',
      ...
      // RISCALDAMENTO (10)
      {
        id: uid(), name: 'Psicocinesi con variazioni cromatiche', nameEn: 'Psychokinetic warmup with colour cues',
        category: 'riscaldamento',
      ...
      {
        id: uid(), name: 'Circuito mobilità articolare con palla', nameEn: 'Articular mobility circuit with ball',
        category: 'riscaldamento',
      ...
      {
        id: uid(), name: 'Rondo 4+2vs2 a tema uscita', nameEn: 'Rondo 4+2vs2 with exit theme',
        category: 'riscaldamento',
      ...
      {
        id: uid(), name: 'Activación dinámica FIFA 11+', nameEn: 'FIFA 11+ Dynamic Activation Protocol',
        category: 'riscaldamento',
      ...
      {
        id: uid(), name: 'Futebol de esquema — riscaldamento brasiliano', nameEn: 'Brazilian scheme football warmup',
        category: 'riscaldamento',
      ...
      {
        id: uid(), name: 'Labirinto cognitivo con numerazione', nameEn: 'Cognitive labyrinth with numbering',
        category: 'riscaldamento',
      ...
      {
        id: uid(), name: 'Riscaldamento differenziato per ruolo', nameEn: 'Role-specific differentiated warmup',
        category: 'riscaldamento',
      ...
      {
        id: uid(), name: 'Passing square a 4 con incrocio', nameEn: 'Passing square of 4 with crossing runs',
        category: 'riscaldamento',
      ...
      {
        id: uid(), name: 'Obstacle course con palla al piede', nameEn: 'Ball at feet obstacle course',
        category: 'riscaldamento',
      ...
      {
        id: uid(), name: 'Tic-tac-toe umano con palla', nameEn: 'Human tic-tac-toe with ball',
        category: 'riscaldamento',
      ...
      // TECNICA (12)
      {
        id: uid(), name: 'Controllo orientato Coerver avanzato', nameEn: 'Advanced Coerver oriented control',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Wall passing a specchio — 1000 tocchi', nameEn: 'Mirror wall passing — 1000 touches',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Dribbling 1vs1 con porta laterale', nameEn: '1v1 dribbling with lateral mini-goal',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Passaggio filtrante in corsa — linee spezzate', nameEn: 'Through pass in motion — broken lines',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Colpo di testa — circuito a 5 stazioni', nameEn: 'Heading circuit — 5 stations',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Tiro in caduta — volée e rovesciata tecnica', nameEn: 'Falling shot — volley and bicycle kick technique',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Triangolo tecnico con terzo uomo', nameEn: 'Technical triangle with third man run',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Cross e finalizzazione 3 zone', nameEn: 'Crossing and finishing — 3 zone attack',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Stop e tiro da fuori area — tecnica del destro e sinistro', nameEn: 'Control and shoot from outside — both feet',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Conduzione di velocità e cambio di passo', nameEn: 'Speed dribbling and change of pace',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Palla lunga e controllo — lancio del portiere', nameEn: 'Long ball and control — goalkeeper distribution',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Tecnica del pressing individuale — chiusura dello spazio', nameEn: 'Individual pressing technique — space closure',
        category: 'tecnica',
      ...
      // TATTICA (12)
      {
        id: uid(), name: 'Costruzione bassa dal portiere 3+GK vs 2', nameEn: 'Low build-up from GK 3+GK vs 2',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Transizione offensiva 5vs5+2 jolly', nameEn: 'Offensive transition 5v5+2 jokers',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Pressing a zona — trigger e compattezza', nameEn: 'Zonal pressing — trigger and compactness',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Superiorità numerica in zona: 3vs2+1', nameEn: 'Numerical superiority in zone: 3v2+1',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Difesa della profondità — linea alta e offside', nameEn: 'Depth defence — high line and offside trap',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Possesso con cambio di fronte obbligatorio', nameEn: 'Possession with mandatory switch of play',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Mezzala in proiezione offensiva — inserimento sul 3-5-2', nameEn: 'Mezzala in offensive projection — 3-5-2 insertion',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Pressing coordinato in 4-4-2 — blocco mediano', nameEn: 'Coordinated pressing in 4-4-2 — medium block',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Fase offensiva 4-3-3 — attacco alla profondità della seconda punta', nameEn: '4-3-3 offensive phase — second striker depth attack',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Zona mista 4-2-3-1 — transizione difensiva organizzata', nameEn: '4-2-3-1 mixed zone — organized defensive transition',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Gestione del vantaggio — rallentamento con possesso', nameEn: 'Lead management — slowdown through possession',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Calcio d\'angolo difensivo — zona vs uomo', nameEn: 'Defensive corner kick — zone vs man marking',
        category: 'tattica',
      ...
      // ATLETICO (10)
      {
        id: uid(), name: 'Sprint ripetuti RSA 30-15 con palla', nameEn: 'Repeated Sprint Ability 30-15 with ball',
        category: 'atletico',
      ...
      {
        id: uid(), name: 'Forza esplosiva: salti pliometrici a circuito', nameEn: 'Explosive power: plyometric jump circuit',
        category: 'atletico',
      ...
      {
        id: uid(), name: 'Interval training Yo-Yo Test simulato', nameEn: 'Yo-Yo Intermittent Recovery Test simulation',
        category: 'atletico',
      ...
      {
        id: uid(), name: 'Core stability calcistico — plank progressivo', nameEn: 'Football core stability — progressive plank',
        category: 'atletico',
      ...
      {
        id: uid(), name: 'Agilità percettiva con stimolo visivo (Reactive Agility)', nameEn: 'Perceptual agility with visual stimulus (Reactive Agility)',
        category: 'atletico',
      ...
      {
        id: uid(), name: 'Forza funzionale calcistica — circuito 6 stazioni', nameEn: 'Football functional strength — 6-station circuit',
        category: 'atletico',
      ...
      {
        id: uid(), name: 'Fartlek calcistico — variazioni di ritmo simulate', nameEn: 'Football fartlek — simulated pace variations',
        category: 'atletico',
      ...
      {
        id: uid(), name: 'Mobilità degli arti inferiori — protocollo FMS', nameEn: 'Lower limb mobility — FMS protocol',
        category: 'atletico',
      ...
      // PARTITELLA (8)
      {
        id: uid(), name: 'Partitella a tema: pressing e transizione', nameEn: 'Themed small-sided game: pressing and transition',
        category: 'partitella',
      ...
      {
        id: uid(), name: 'Rondo 8vs2 in doppia griglia', nameEn: 'Rondo 8v2 double grid',
        category: 'partitella',
      ...
      {
        id: uid(), name: 'Partitella con regola del gol da fuori', nameEn: 'Small-sided game with outside goal rule',
        category: 'partitella',
      ...
      {
        id: uid(), name: 'Partitella con jolly di fascia', nameEn: 'Small-sided game with wide jokers',
        category: 'partitella',
      ...
      {
        id: uid(), name: 'Partitella 9vs9 con regola del tocco', nameEn: '9v9 with touch constraint rule',
        category: 'partitella',
      ...
      {
        id: uid(), name: 'Partitella per reparto: difensori vs attaccanti', nameEn: 'Department game: defenders vs attackers',
        category: 'partitella',
      ...
      {
        id: uid(), name: 'Partitella con porte multiple a colori', nameEn: 'Multi-goal coloured small-sided game',
        category: 'partitella',
      ...
      {
        id: uid(), name: 'Partitella con possesso obbligatorio nella metà campo difensiva', nameEn: 'Game with mandatory possession in defensive half',
        category: 'partitella',
      ...
      // CALCI PIAZZATI (10)
      {
        id: uid(), name: 'Calcio d\'angolo offensivo a zona — schema Liverpool', nameEn: 'Offensive corner — zonal attacking scheme Liverpool',
        category: 'calci_piazzati',
      ...
      {
        id: uid(), name: 'Punizione diretta: tecnica della barriera e del tiro', nameEn: 'Direct free kick: wall technique and shooting',
        category: 'calci_piazzati',
      ...
      {
        id: uid(), name: 'Schema punizione laterale: doppio movimento', nameEn: 'Lateral free kick scheme: double movement',
        category: 'calci_piazzati',
      ...
      {
        id: uid(), name: 'Rimessa laterale lunga — schema di attivazione', nameEn: 'Long throw-in activation scheme',
        category: 'calci_piazzati',
      ...
      {
        id: uid(), name: 'Calcio di rigore: protocollo mentale e tecnico', nameEn: 'Penalty kick: mental and technical protocol',
        category: 'calci_piazzati',
      ...
      {
        id: uid(), name: 'Schema calcio d\'angolo corto — triangolo veloce', nameEn: 'Short corner scheme — fast triangle',
        category: 'calci_piazzati',
      ...
      {
        id: uid(), name: 'Punizione nella propria metà campo — costruzione', nameEn: 'Own-half free kick — build-up scheme',
        category: 'calci_piazzati',
      ...
      {
        id: uid(), name: 'Schema punizione in fascia: cross al secondo palo', nameEn: 'Wide free kick scheme: cross to far post',
        category: 'calci_piazzati',
      ...
      {
        id: uid(), name: 'Calcio di punizione ad effetto — curva a cadere', nameEn: 'Free kick with effect — dropping curve',
        category: 'calci_piazzati',
      ...
      {
        id: uid(), name: 'Ripartenza veloce da calcio d\'angolo — contropiede schematizzato', nameEn: 'Fast restart from corner — schematic counter',
        category: 'calci_piazzati',
      ...
      // PORTIERI (10)
      {
        id: uid(), name: 'Tuffo laterale — tecnica del diving progressiva', nameEn: 'Lateral dive — progressive diving technique',
        category: 'portieri',
      ...
      {
        id: uid(), name: 'Uscita alta sul cross — tecnica della presa aerea', nameEn: 'High exit on cross — aerial catch technique',
        category: 'portieri',
      ...
      {
        id: uid(), name: 'Distribuzione del portiere — 4 tipi di rilancio', nameEn: 'Goalkeeper distribution — 4 types of release',
        category: 'portieri',
      ...
      {
        id: uid(), name: 'Reazione su tiro ravvicinato — riflessi e posizione', nameEn: 'Close-range reaction save — reflexes and positioning',
        category: 'portieri',
      ...
      {
        id: uid(), name: 'Portiere in costruzione — ruolo nel 3-4-3', nameEn: 'GK in build-up — role in 3-4-3',
        category: 'portieri',
      ...
      {
        id: uid(), name: 'Parata del tiro a giro — tecnica del palo vicino', nameEn: 'Curling shot save — near post technique',
        category: 'portieri',
      ...
      {
        id: uid(), name: 'Uscita in profondità 1vs1 — postura e chiusura dell\'angolo', nameEn: '1v1 depth exit — posture and angle closure',
        category: 'portieri',
      ...
      {
        id: uid(), name: 'Coordinazione portiere — circuito atletico specifico', nameEn: 'GK coordination — sport-specific athletic circuit',
        category: 'portieri',
      ...
      {
        id: uid(), name: 'Comunicazione con la difesa — organizzazione sui cross', nameEn: 'Communication with defense — organization on crosses',
        category: 'portieri',
      ...
      {
        id: uid(), name: 'Tiro in tuffo su secondo palo — tecnica avanzata', nameEn: 'Diving save far post — advanced technique',
        category: 'portieri',
      ...
      // ── TECNICA ──
      {
        id: uid(), name: 'Controllo di petto e scarico rapido', nameEn: 'Chest control and quick release',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Giocoleria con obiettivi: sequenze miste', nameEn: 'Juggling with targets: mixed sequences',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Passaggio di prima intenzione in movimento — quadrato a 6', nameEn: 'First-time passing in movement — 6-man square',
        category: 'tecnica',
      ...
      {
        id: uid(), name: 'Finta e doppio passo — circuito a coni', nameEn: 'Feint and double step — cone circuit',
        category: 'tecnica',
      ...
      // ── TATTICA ──
      {
        id: uid(), name: 'Difesa del blocco basso: 4-1-4-1 compatto', nameEn: 'Low block defense: compact 4-1-4-1',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Sovraccarico laterale: 3vs2 sulle fasce', nameEn: 'Wide overload: 3v2 on the flanks',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Uscita dalla pressione: rombo centrocampo', nameEn: 'Escape the press: midfield diamond',
        category: 'tattica',
      ...
      {
        id: uid(), name: 'Attacco posizionale: principio del terzo uomo', nameEn: 'Positional attack: third-man principle',
        category: 'tattica',
      ...
      // ── ATLETICO ──
      {
        id: uid(), name: 'Circuito SAQ: scala, coni, ostacoli', nameEn: 'SAQ circuit: ladder, cones, hurdles',
        category: 'atletico',
      ...
      {
        id: uid(), name: 'Forza esplosiva: squat jump + accelerazione', nameEn: 'Explosive strength: squat jump + acceleration',
        category: 'atletico',
      ...
      {
        id: uid(), name: 'Resistenza specifica: 8x200m con palla', nameEn: 'Specific endurance: 8×200m with ball',
        category: 'atletico',
      ...
      // ── RISCALDAMENTO ──
      {
        id: uid(), name: 'Riscaldamento in possesso 3 tocchi max', nameEn: 'Possession warm-up 3 touches max',
        category: 'riscaldamento',
      ...
      {
        id: uid(), name: 'Attivazione dinamica con elastici e sprint', nameEn: 'Dynamic activation with bands and sprints',
        category: 'riscaldamento',
      ...
      // ── PARTITELLA ──
      {
        id: uid(), name: 'Partitella 7vs7 su campo stretto — verticalità', nameEn: '7v7 small-sided game — verticality',
        category: 'partitella',
      ...
      {
        id: uid(), name: 'Partitella con jolly centrale fisso', nameEn: 'Small-sided game with fixed central joker',
        category: 'partitella',
      ...
      {
        id: uid(), name: 'Partitella a zone con bonus possesso', nameEn: 'Zoned match with possession bonus',
        category: 'partitella',
      ...
      // ── CALCI PIAZZATI ──
      {
        id: uid(), name: 'Calcio d\'angolo corto: 2-1 con cross arretrato', nameEn: 'Short corner: 2-1 with cutback cross',
        category: 'calci_piazzati',
      ...
      {
        id: uid(), name: 'Punizione laterale: scarico e tiro dalla trequarti', nameEn: 'Wide free kick: lay-off and shot from the edge',
        category: 'calci_piazzati',
      ...
      {
        id: uid(), name: 'Rimessa dal fondo: costruzione GK + uscita', nameEn: 'Goal kick: GK build-up and press escape',
        category: 'calci_piazzati',
      ...
      // ── PORTIERI ──
      {
        id: uid(), name: 'Portiere: piede — distribuzione corta e lunga', nameEn: 'Goalkeeper: feet — short and long distribution',
        category: 'portieri',
      ...
      {
        id: uid(), name: 'Portiere: 1vs1 uscita bassa — tecnica del piede', nameEn: 'Goalkeeper: 1v1 low exit — foot technique',
        category: 'portieri',
